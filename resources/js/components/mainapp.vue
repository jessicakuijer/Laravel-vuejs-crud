      ...
      <div class="_1side_menu" >
        ...
        <div class="_1side_menu_content">
          <div class="_1side_menu_img_name">
            ...
            <p class="_1side_menu_name">Menu</p>
          </div>

          <!--~~~ MENU LIST ~~~~~~-->
          <div class="_1side_menu_list">
            <ul class="_1side_menu_list_ul">
              <li><router-link to="/"><Icon type="ios-aperture" /> Accueil</router-link></li>
              <li><router-link to="tags"><Icon type="ios-musical-notes" /> Playlist collaborative</router-link></li>
            </ul>
          </div>
        </div>
      </div>
